...
?>
    ...
    <td><?php echo $data['nama_gejala'];?></td>
    <td width="4%" align="center"><a href="?page=5t&amp;act=editgejala&amp;kode_gejala=<?php echo $data['kode_gejala'];?>"><img src="images/Modify.png" width="20" height="20" border="0" align="absmiddle" /> Ya</a></td>
    <td width="5%" align="center"><a href="?page=5&act=hapusgejala&kode_gejala=<?php echo $data['kode_gejala'];?>" onclick="return confirm('Apakah anda yakin data gejala ini akan dihapus?')"><img src="images/Erase.png" width="20" height="20" border="0" align="absmiddle"> Tidak</a></td>
  </tr>
  <?php }?>
  <tr>
	<td colspan="4" align="center"><a href="?page=5&act=tambahgejala"><img src="images/95.png" width="24" height="24"  border="0" align="absmiddle"> Tambah</a></td>
